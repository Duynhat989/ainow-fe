<template>
  <div class="support-page">
    <div class="container">
      <h1 class="page-title">{{ $t('SUPPORT_TITLE') }}</h1>
      <p class="page-subtitle">{{ $t('SUPPORT_SUBTITLE') }}</p>

      <div class="support-container">
        <!-- Search Section -->
        <section class="search-section">
          <div class="search-box">
            <input type="text" v-model="searchQuery" :placeholder="$t('SUPPORT_SEARCH_PLACEHOLDER')"
              @keyup.enter="handleSearch" />
            <button class="search-button" @click="handleSearch">
              <span>{{ $t('SUPPORT_SEARCH_BUTTON') }}</span>
            </button>
          </div>
        </section>
        ...
        <section class="faq-section">
          <h2 class="section-title">{{ $t('SUPPORT_FAQ_TITLE') }}</h2>
        ...
        <section class="contact-support-section">
          <div class="contact-card">
            <div class="contact-content">
              <h2>{{ $t('SUPPORT_STILL_NEED_HELP') }}</h2>
              ...
              <div class="contact-methods">
                <div class="contact-method">
                  ...
                  <div>
                    <h4>{{ $t('SUPPORT_EMAIL_TITLE') }}</h4>
                    <p>{{ $t('SUPPORT_EMAIL_DESC') }}</p>
                ...
                <div class="contact-method">
                  ...
                  <div>
                    <h4>{{ $t('SUPPORT_CHAT_TITLE') }}</h4>
                    <p>{{ $t('SUPPORT_CHAT_DESC') }}</p>
                    <button class="chat-button" @click="openLiveChat">{{ $t('SUPPORT_CHAT_BUTTON') }}</button>
                  </div>
                </div>
                ...
                <div class="contact-method">
                  <div class="contact-method-icon">📚</div>
                  <div>
                    <h4>{{ $t('SUPPORT_DOCS_TITLE') }}</h4>
                    <p>{{ $t('SUPPORT_DOCS_DESC') }}</p>
                    <a href="#" class="contact-link">{{ $t('SUPPORT_DOCS_LINK') }}</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="contact-image">
              <img
                src="https://cdn.prod.website-files.com/59e16042ec229e00016d3a66/63f59ad81f9e28b327a95d59_Top%20generative%20AI%20tools_Blog%20hero.webp"
      ...
      <section class="resources-section">
        <h2 class="section-title">{{ $t('SUPPORT_RESOURCES_TITLE') }}</h2>

        <div class="resources-grid">
          <a href="#" class="resource-card">
            <div class="resource-icon">📝</div>
            <h3>{{ $t('SUPPORT_RESOURCE_TUTORIALS') }}</h3>
            <p>{{ $t('SUPPORT_RESOURCE_TUTORIALS_DESC') }}</p>
          </a>

          <a href="#" class="resource-card">
            <div class="resource-icon">🎬</div>
            <h3>{{ $t('SUPPORT_RESOURCE_VIDEOS') }}</h3>
            <p>{{ $t('SUPPORT_RESOURCE_VIDEOS_DESC') }}</p>
          </a>

          <a href="#" class="resource-card">
            <div class="resource-icon">🔄</div>
            <h3>{{ $t('SUPPORT_RESOURCE_UPDATES') }}</h3>
            <p>{{ $t('SUPPORT_RESOURCE_UPDATES_DESC') }}</p>
          </a>

          <a href="#" class="resource-card">
            <div class="resource-icon">💡</div>
            <h3>{{ $t('SUPPORT_RESOURCE_TIPS') }}</h3>
            <p>{{ $t('SUPPORT_RESOURCE_TIPS_DESC') }}</p>
          </a>
        </div>
      </section>
    </div>
