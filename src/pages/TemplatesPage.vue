<template>
    <div class="templates-page">
      <div class="container">
        <h1 class="page-title">Thư Viện Mẫu</h1>
        <p class="page-subtitle">Khám phá và sử dụng các mẫu thiết kế chuyên nghiệp</p>
        
        <div class="templates-filters">
          <div class="search-bar">
            <input type="text" placeholder="Tìm kiếm mẫu..." v-model="searchQuery" />
          </div>
          ...
          >
            <div class="template-preview">
              ...
              <div class="template-actions">
                ...
                <button class="btn-preview">Xem trước</button>
              </div>
            </div>
