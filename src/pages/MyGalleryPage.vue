<template>
    <div class="gallery-page">
      <div class="container">
        ...
        <p class="page-subtitle">Quản lý và chia sẻ các ảnh đã chỉnh sửa của bạn</p>
        
        <div class="gallery-controls">
          <div class="gallery-search">
            <input type="text" placeholder="Tìm kiếm ảnh..." v-model="searchQuery" />
          </div>
          ...
          <div class="gallery-filters">
            ...
            <select v-model="filterBy">
              ...
              <option value="original">Ảnh gốc</option>
        ...
        <div v-if="images.length === 0" class="empty-gallery">
          ...
          <p>Bắt đầu chỉnh sửa ảnh để thêm vào thư viện của bạn</p>
          <router-link to="/editor" class="btn btn-primary">Tải ảnh lên</router-link>
        </div>
        ...
        <div v-if="showShareModal" class="modal-overlay" @click="showShareModal = false">
          <div class="modal-content" @click.stop>
            ...
            <div class="share-link">
              ...
              <button @click="copyShareLink">Sao chép</button>
            </div>
            <button class="modal-close" @click="showShareModal = false">Đóng</button>
          </div>
        </div>
